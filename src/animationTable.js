...
class TableEnterLeave extends React.Component {
  ...
  constructor(props) {
    ...
    this.pageLeaveAnim = [{ duration: 150, opacity: 0 }, { height: 0, duration: 150, ease: "easeOutQuad" }];
    this.data = [
      {
        key: 1,
        name: "John Brown",
        ...
        <div className={`${this.props.className}-wrapper`}>
          <div className={this.props.className}>
            ...
            <div className={`${this.props.className}-nav`}>
              <span>
                <img height="24" alt="img" src="https://zos.alipayobjects.com/rmsportal/TOXWfHIUGHvZIyb.svg" />
                <img height="14" alt="img" src="https://zos.alipayobjects.com/rmsportal/bNfCyCcgnyTgRmz.svg" />
              </span>
            </div>
...
ReactDOM.render(<TableEnterLeave />, mountNode);
